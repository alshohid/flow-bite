...
export default function SideBar() {
  ...
  const [openSubmenu, setIsOpenSubmenu] = useState(false);
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                {/* <svg
                  ...
                  viewBox="0 0 18 16"
                >
                  <path d="M1 3h16a1 1 0 1 0 0-2H1a1 1 0 1 0 0 2Zm16 10H1a1 1 0 1 0 0 2h16a1 1 0 1 0 0-2ZM1 9h16a1 1 0 1 0 0-2H1a1 1 0 1 0 0 2Z" />
                </svg> */}
            ...
            <li>
              <button
                type="button"
                onClick={() => setIsOpenSubmenu(!openSubmenu)}
              ...
              >
                <svg
                  ...
                  viewBox="0 0 18 21"
                >
                  <path d="M15 12a1 1 0 0 0 .962-.726l2-7A1 1 0 0 0 17 3H3.77L3.175.745A1 1 0 0 0 2.208 0H1a1 1 0 0 0 0 2h.438l.6 2.255v.019l2 7 .746 2.986A3 3 0 1 0 9 17a2.966 2.966 0 0 0-.184-1h2.368c-.118.32-.18.659-.184 1a3 3                  a3 0 1 0 3-3H6.78l-.5-2H15Z" />
                </svg>
              ...
              <ul
                id="dropdown-example"
                className={
                  openSubmenu ? "py-2 space-y-2" : " hidden py-2 space-y-2"
                }
              >
                <li>
                  <a
